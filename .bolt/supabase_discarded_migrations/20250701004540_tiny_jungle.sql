/*
  ...
  1. Tables
    - `company_livemood_stats` - Tracks aggregated vote statistics per company
    - `company_livemood_votes` - Individual user votes for companies

  2. Functions
    - `calculate_trend_direction` - Calculates trend based on vote percentages
    - `update_company_livemood_stats` - Updates aggregated statistics
    - `trigger_update_livemood_stats` - Trigger function for automatic updates

  3. Triggers
    - Automatic stats updates when votes change
