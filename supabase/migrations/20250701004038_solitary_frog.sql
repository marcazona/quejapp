/*
  # LiveMood Tracking Implementation

  1. Schema Updates
    - Ensures company_livemood_stats table exists
    - Resets all stats to start from 0
    - Ensures every company has a stats record
    - Clears existing votes for fresh start

  2. Performance Improvements
    - Updates trend calculation to be more responsive
